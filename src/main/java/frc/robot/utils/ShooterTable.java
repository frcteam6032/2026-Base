...
public class ShooterTable {
    ...
    private static void fillInTable() {
        // Shooter
        addEntryShooter(Feet.of(6.5), RPM.of(2700));
        addEntryShooter(Feet.of(7.5), RPM.of(2760));
        addEntryShooter(Feet.of(8.5), RPM.of(2860));
        addEntryShooter(Feet.of(9.5), RPM.of(2985));
        addEntryShooter(Feet.of(10.5), RPM.of(3050));
        addEntryShooter(Feet.of(11.5), RPM.of(3150));
        addEntryShooter(Feet.of(12.5), RPM.of(3250));
        addEntryShooter(Feet.of(13.5), RPM.of(3350));
